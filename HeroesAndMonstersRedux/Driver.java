...
public class Driver{
    public static void main(String args[]){
        ...
        String directChoice = "";
        int farmOneX = 0, farmOneY = 0, farmTwoX = 0, farmTwoY = 0;
        ...
        while (numFarmer < 2){
            ...
            if (map[farmer.getX()][farmer.getY()] == null){
                ...
                numFarmer += 1;
                if (numFarmer == 1){
                    farmOneX = farmer.getX();
                    farmOneY = farmer.getY();
                }
                else if(numFarmer == 2){
                    farmTwoX = farmer.getX();
                    farmTwoY = farmer.getY();
                }
            }
        }
